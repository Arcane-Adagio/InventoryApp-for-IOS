...
struct StockInventoryView: View {
    @ObservedObject var viewmodel = OfflineStockInventoryViewModel.singleton
    var sampleList: [InventoryItem] = []
        ...
        NavigationStack {
            ZStack {
                ...
                VStack {
                    ScrollView {
                        LazyVStack {
                            ForEach(viewmodel.inventoryItems) { _ in
                                StockItemCardView()
                                    .padding(.vertical, 5)
            ...
            .navigationTitle("Sample Inventory")
...
struct StockInventoryView_Previews: PreviewProvider {
